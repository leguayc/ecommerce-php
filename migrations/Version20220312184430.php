 ...
 */
final class Version20220312184430 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE user_adress ADD user_id INT DEFAULT NULL');
